...
# Next Steps for ndx-labmetadata-example Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-labmetadata-example directory.
...
`spec/ndx-labmetadata-example.namespace.yaml` and
`spec/ndx-labmetadata-example.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-labmetadata-example
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/oruebel/ndx-labmetadata-example/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
`staged-extensions/ndx-labmetadata-example`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-labmetadata-example
    ```

13. Edit `staged-extensions/ndx-labmetadata-example/ndx-meta.yaml`
...
14. Edit `staged-extensions/ndx-labmetadata-example/README.md`
to add information about your extension. You may copy it from
`ndx-labmetadata-example/README.md`.
...
ndx-labmetadata-example-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-labmetadata-example GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-labmetadata-example-record repository on GitHub.
